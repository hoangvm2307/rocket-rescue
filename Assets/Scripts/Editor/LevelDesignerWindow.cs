...
public class LevelDesignerWindow : EditorWindow
{
    ...
    private static class Constants
    {
        ...
        // Prefab & Asset Paths
        public static readonly string[] PrefabSearchPaths = { "Assets/Prefabs/Character", "Assets/Prefabs/Environment" };
        public const string GameObjectAssetQuery = "t:GameObject";
        public const string DefaultPlatformPrefabDir = "Assets/Prefabs/Environment";
